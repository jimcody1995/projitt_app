...
import { EllipsisVertical, Mic, MicOff, Settings, Video, VideoOff, Loader2 } from "lucide-react";
import { useEffect, useRef, useState } from "react";
import { useRouter } from "next/navigation";

export default function CheckingCamera() {
    ...
    return <div className="w-[480px] flex flex-col items-center" >
        ...
        {/* Video/Preview Area */}
        <div className="mt-[40px] relative bg-[#e9e9e9] rounded-[20px] w-full h-[340px] flex justify-center items-center overflow-hidden">
            {/* Permission Controls */}
        ...
        <div className="flex justify-between mt-[24px] w-full">
                ...
                <div className="h-[48px] border border-[#8f8f8f] rounded-[8px] flex">
                    ...
                    >
                        {isMicEnabled ? (
                            ...
                            <MicOff className="text-[#626262] size-[32px]" />
                        )}
                    </button>
                    <div className="w-[41px] h-full flex justify-center items-center">
                        <EllipsisVertical className="text-[#626262] size-[24px]" />
                    </div>
                </div>
                ...
                <div className="h-[48px] border border-[#8f8f8f] rounded-[8px] flex">
                    ...
                    >
                        {isVideoEnabled ? (
                            ...
                            <VideoOff className="text-[#626262] size-[32px]" />
                        )}
                    </button>
                    <div className="w-[41px] h-full flex justify-center items-center">
                        <EllipsisVertical className="text-[#626262] size-[24px]" />
            ...
            <div className="cursor-pointer w-[48px] h-[48px] border border-[#8f8f8f] rounded-[8px] flex justify-center items-center">
                <Settings className="text-[#626262] size-[32px]" />
            </div>
        </div>
